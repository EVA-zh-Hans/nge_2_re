...
### 📰 最新进展
- [2026/08] 在 2026 年 PSPHDC 开发者大会上介绍该《新世纪福音战士 2》中文本地化项目，[幻灯片](https://eva-zh-hans.github.io/PSPHDC2026_nge_2)
- [2026/06] 更新补丁架构，通过修改语序实现记忆文本汉化，添加汉化组滚动职员表，修复机密情报显示问题
- [2026/05] 汉化测试版`v1.1.0-beta.1`发布，Katsumi-Mole 加入项目
- [2026/04] 汉化测试版`v1.0.0-beta.1`发布，TPU 标星本仓库，blabubble 加入项目
- [2026/03] pan1927412 加入项目，插件版补丁可行性验证
- [2026/02] 添加贡献者启动页面
...
#### 2026 年
- **[06/26]** 添加汉化组滚动职员表
- **[06/13]** 修复机密情报显示问题，为翻译文本添加检查和自动修复工具
- **[06/05]** 将补丁架构更改为启动器与运行时插件，通过修改语序实现记忆文本的汉化
- **[05/29]** Katsumi-Mole 加入项目
- **[04/28]** 汉化届传奇人物 TPU 标星了本仓库！
- **[04/27]** 汉化测试版`v1.0.0-beta.1`发布，blabubble 加入项目
- **[03/12]** pan1927412 加入项目
- **[03/04]** 插件版补丁可行性验证
- **[02/08]** 添加贡献者启动页面
...
* [ZhenjianYang/ZeroAoVoice-PSP](https://github.com/ZhenjianYang/ZeroAoVoice-PSP)
* 全体参与汉化与校对的志愿者们 ❤️
